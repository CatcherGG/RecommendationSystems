...
def load_thumbnail_embaddings(load_thumbnail_embeddings_path):
    thumbnail_embeddings = deserialize(load_thumbnail_embeddings_path)
    tf.logging.info("Read article thumbnail embeddings {}:".format(len(thumbnail_embeddings.keys())))

    return thumbnail_embeddings
